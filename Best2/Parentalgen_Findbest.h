void FirstParentalGeneration(float ****FullListAd, float **FitnessAd,float ****FullList2Ad, float **Fitness2Ad,float ****FullList3Ad, float **Fitness3Ad, float ***BaseStructure, int *CardsStudied,int realcards,int manysites,int manyparentals,int manycards){
    int *provisoryArray;
...
void NextList(float ***FullList,float *Fitness,float ***FullList3,float *Fitness3,int manycards,int r){    
    for(int i=0;i<manycards;i++){
