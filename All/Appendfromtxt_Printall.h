...
void FreeForAll(float ***BaseStructure, float ***FullList, float *Fitness, float ***FullList2, float *Fitness2, int *CardsStudied,int realcards,int manysites,int manyparentals,int manycards){
    for(int i=0;i<manysites;i++){
